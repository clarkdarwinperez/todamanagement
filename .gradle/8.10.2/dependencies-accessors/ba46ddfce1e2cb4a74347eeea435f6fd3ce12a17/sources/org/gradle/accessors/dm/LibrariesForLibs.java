...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class MongodbDriverLibraryAccessors extends SubDependencyFactory {
        private final MongodbDriverKotlinLibraryAccessors laccForMongodbDriverKotlinLibraryAccessors = new MongodbDriverKotlinLibraryAccessors(owner);

        public MongodbDriverLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mongodb.driver.kotlin</b>
         */
        public MongodbDriverKotlinLibraryAccessors getKotlin() {
            return laccForMongodbDriverKotlinLibraryAccessors;
        }

    }

    public static class MongodbDriverKotlinLibraryAccessors extends SubDependencyFactory {

        public MongodbDriverKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>coroutine</b> with <b>org.mongodb:mongodb-driver-kotlin-coroutine</b> coordinates and
         * with version reference <b>mongodbDriverKotlinCoroutine</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            return create("mongodb.driver.kotlin.coroutine");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mongodbDriverKotlinCoroutine</b> with value <b>5.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMongodbDriverKotlinCoroutine() { return getVersion("mongodbDriverKotlinCoroutine"); }
